...
/**
 * Initializes the rendering by setting sky objects and light sources.
 *
...
/**
 * Handles keydown events for camera movement and toggling the pause state.
 *
 ...
 *
 * @function moveCamera
 * @param {string} direction - The direction in which to move the camera ('forward', 'backward', 'left', 'right').
 * @returns {void}
 */
...
/**
 * Renders the scene, updates the sun and moon positions, and calls the next animation frame.
 *
 * @function render
 * @returns {void}
 */
