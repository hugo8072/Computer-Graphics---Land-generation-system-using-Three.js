...
/**
 * Adds rain to the scene, creating raindrop geometry and animation.
 *
 * @function addRain
 * @returns {void}
 */
export function addRain () {
  ...
  /**
   * Updates raindrop positions and animates the rain.
   *
   * @function updateRain
   * @returns {void}
   */
...
/**
 * Removes the rain from the scene if it exists.
 *
 * @function removeRain
 * @returns {void}
 */
